...
<html lang="en">
   ...
   <body>
      ...
      <!-- /#page-title -->
      <!-- #our-mission -->
      <section id="our-mission" dir="rtl">
         <div class="container">
            <div class="row">
               <div class="col-md-4">
               ...
               <div class="col-lg-8 col-md-8 col-sm-12 image-caption">
                  ...
                  <div class="">
                     <h2>خدماتنا  </h2>
                     <p>أبجد هوز هو مجرد دمية النص لصناعة الطباعة والتنضيد. كان Lorem Ipsum هو النص الوهمي القياسي في الصناعة منذ القرن الخامس عشر الميلادي ، عندما أخذت طابعة غير معروفة لوحًا

                     </p>
                     <ul>
                     <li><i class="fa fa-arrow-circle-o-right"></i>  ليس لدينا صيانة وفقا لصناعة التنضيد وقت العمل. لقد كان Lorem Ipsum هو النص المعياري في هذه الصناعة منذ عام 1500
</li>
     ...
     <section id="testimonials-construct-home">
      ...
      <section id="clients" class="construct">
         <div class="container">
            <div class="section-title black" dir="rtl">
               <h1>لقد عملنا مع عملاء رائعين  </h1>
            </div>
            <div class="row">
