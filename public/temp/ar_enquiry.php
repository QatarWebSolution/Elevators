...
<html lang="en">
   ...
   <body>
            ...
            <div class="row">
               <div class="col-lg-12">
                  ...
                  <div class="page-breadcumb pull-left">
                     ...
                     <a href="ar_index.php">Home</a> 
                     <i class="fa fa-angle-left"></i> 
                     <a href="#">اتصل بنا   </a> 
                     <i class="fa fa-angle-left"></i>                    
                     <span>نموذج الاستفسار  </span>
                  </div>
                  <!-- /.page-breadcumb -->
               </div>
            </div>
      ...
      <!-- /#page-title -->
      <section id="contact-content" class="fullwidthall" dir="rtl">
         <div class="container register">
            <div class="fulwidth">
               <div class="col-md-3 register-left">
                  <img src="https://image.ibb.co/n7oTvU/logo_white.png" alt=""/>
                  <h3>نموذج الاستفسار  </h3>
                  <p>ليس لدينا أي أنشطة أخرى. نقوم بتوريد وتركيب جميع أنواع المصاعد: الأبراج (بسرعات عالية تصل إلى 6 م) والمباني التجارية والفيلات والمصاعد لذوي الاحتياجات الخاصة.
</p>
                        ...
                        <div class="row register-form">
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label>اسم  <sup>*</sup></label>
                                 <input type="text" class="form-control" placeholder="الاسم الكامل  " value="" />
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label>هاتف   </label>
                                 <input type="number" class="form-control" placeholder="رقم الهاتف  " value="" />
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label>البريد الإلكتروني  <sup>*</sup></label>
                                 <input type="password" class="form-control" placeholder="البريد الإلكترون  " value="" />
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                           ...
                           <div class="col-md-12">
                              <input type="submit" class="btnRegister"  value="خضع "/>
                           </div>
                        </div>
                     </div>
                  </div>
